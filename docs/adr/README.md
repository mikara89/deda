...
| [0005](0005-in-process-kestrel-server.md)       | In-Process Kestrel HTTP Server as a Hosted Service                | Accepted |
| [0006](0006-hand-rolled-metrics-registry.md)    | Hand-Rolled In-Process Prometheus Metrics Registry                | Accepted |
