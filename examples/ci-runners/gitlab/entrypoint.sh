...
config_file=${GITLAB_RUNNER_CONFIG:-/home/deda/.gitlab-runner/config.toml}
token_file=${GITLAB_RUNNER_TOKEN_FILE:-/run/secrets/gitlab-runner-auth}
runner_name=${GITLAB_RUNNER_NAME:-deda-gitlab-${HOSTNAME}}
...
registered=true
gitlab-runner run --config "$config_file" & runner_pid=$!
